...
zypper ar -f -n http://download.opensuse.org/repositories/games/openSUSE_Tumbleweed/ games
zypper ar -f -n https://download.opensuse.org/repositories/X11:/XOrg/openSUSE_Tumbleweed/ xorg_x11
zypper ar -f -n https://download.opensuse.org/repositories/hardware/openSUSE_Tumbleweed/ hardware
zypper ar -f -n https://download.opensuse.org/repositories/Emulators/openSUSE_Tumbleweed/ emulators
