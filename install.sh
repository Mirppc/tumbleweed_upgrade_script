...
zypper ar -f -n -c packman http://ftp.gwdg.de/pub/linux/misc/packman/suse/openSUSE_Tumbleweed/ packman
zypper ar -f -n -c http://download.opensuse.org/repositories/games/openSUSE_Tumbleweed/ games
zypper ar -f -n -c https://download.opensuse.org/repositories/X11:/XOrg/openSUSE_Tumbleweed/ xorg_x11
zypper ar -f -n -c https://download.opensuse.org/repositories/hardware/openSUSE_Tumbleweed/ hardware
zypper ar -f -n -c https://download.opensuse.org/repositories/Emulators/openSUSE_Tumbleweed/ emulators
